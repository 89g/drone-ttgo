...
var tarteaucitron = {
        ...
        tarteaucitron.addScript(pathToLang, '', function () {
          ...
          if(tarteaucitronCustomText !== ''){
            ...
            tarteaucitron.addScript(pathToServices, '', function () {
                ...
                var hotjarlocalHide = "$('#hotjar_local').css('display','none');";
                html += '         <div class="tarteaucitronAsk" id="tarteaucitronScrollbarAdjust">';
                html += '            <button type="button" id="tarteaucitronAllAllowed" class="tarteaucitronAllow" onclick="tarteaucitron.userInterface.respondAll(true);'+hotjarlocalHide+'">';
    ...
    "addService": function (serviceId) {
        ...
        if (tarteaucitron.added[service.key] !== true) {
            ...
            html += '   </div>';            
            var hotjarlocalHide = (service.name=="Hotjar")?"$('#hotjar_local').css('display','none');":"";
            
            html += '   <div class="tarteaucitronAsk">';
            html += '       <button type="button" id="' + service.key + 'Allowed" class="tarteaucitronAllow" onclick="tarteaucitron.userInterface.respond(this, true);'+hotjarlocalHide+'">';
    ...
    "cookie": {
        ...
        "create": function (key, status) {
            ...
            // Sauvegarde du cookie en base
            var idCookie = getCookieID("tarteaucitron");
            if(idCookie !== null){
	            var dateDebut = new Date();
	            dateDebut.setTime(d.getTime() - (365 * 24 * 60 * 60 * 1000));
	            var dataToSend ={id : encodeURIComponent(idCookie),
						name : encodeURIComponent(key),
						value : encodeURIComponent(status),
						dateDebut : encodeURIComponent(dateDebut.toISOString()),
						dateFin : encodeURIComponent(d.toISOString())};
	            ajaxCookieSendContent("/cookie/setCookie", dataToSend);
            }
        },
        "read": function () {
            "use strict";
